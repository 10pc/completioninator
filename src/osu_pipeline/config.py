...
def load_config(explicit: str | Path | None = None) -> PipelineConfig:
    ...
    audio_max_tracks = os.environ.get("PIPELINE_AUDIO_MAX_TRACKS")
    ...
    if cfg_file is not None:
        ...
        audio_max_tracks = int(audio_max_tracks or video.get("audio_max_tracks", 10))
    ...
    return PipelineConfig(
        ...
        max_clips=max_clips,
        audio_max_tracks=audio_max_tracks,
